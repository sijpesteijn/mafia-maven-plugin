...
public abstract class AbstractFitNesseTestCase<F extends Mojo> extends AbstractMojoTestCase {
	...
	protected void setUp(String goal) throws Exception {
		super.setUp();
		...
		ProjectTool projectTool = (ProjectTool) lookup(ProjectTool.ROLE);
		mavenProject = projectTool.readProjectWithDependencies(pom);
