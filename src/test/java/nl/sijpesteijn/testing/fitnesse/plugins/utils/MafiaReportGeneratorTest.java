...
public class MafiaReportGeneratorTest {
	...
	public void testGenerate() throws Exception {
		...
		final ResourceBundle bundle = ResourceBundle
				.getBundle("mafia-report", locale, this.getClass().getClassLoader());
		...
		final ReporterPluginConfig.Builder builder = new ReporterPluginConfig.Builder();
		builder.setFitnesseReportDirectory(basedir.getAbsolutePath());
		final MafiaReportGenerator generator = new MafiaReportGenerator(sink, bundle, builder.build(),
				getMafiaTestResults());
		generator.generate();
	...
	private List<MafiaTestResult> getMafiaTestResults() {
		...
		summary2.ignores = 0;
		summary2.right = 3;
		final MafiaTestResult result1 = new MafiaTestResult(PageType.TEST, "DummyTest1", summary1,
				"some html 1<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>end");
		final MafiaTestResult result2 = new MafiaTestResult(PageType.TEST, "DummyTest2", summary2,
