...
public class ContentPluginConfig implements PluginConfig {
	 ...
	 *            {@link java.lang.String}
	 */
	public ContentPluginConfig(final String wikiRoot,
			final String nameRootPage, final List<String> statics,
			final List<String> resources,
			final List<Dependency> excludeDependencies,
			final List<String> targets,
			final List<String> compileClasspathElements, final String baseDir,
			final Map<String, Artifact> artifactMap) {
	...
	public static class Builder implements PluginConfigBuilder {
		...
		public void setExcludeDependencies(
				final List<Dependency> excludeDependencies) {
		...
		public void setCompileClasspathElements(
		...
		public ContentPluginConfig build() {
			return new ContentPluginConfig(wikiRoot, nameRootPage, statics,
					resources, dependencies, targets, compileClasspathElements,
					baseDir, artifactMap);
		}
	}
	...
	public String toString() {
		return "Base directory: " + this.baseDir + ", Name root page: "
				+ this.nameRootPage + ", Wiki root: " + this.wikiRoot
				+ ", Statics: " + LogUtils.getString(this.statics)
				+ ", Resources: " + LogUtils.getString(this.resources)
				+ ", Targets: " + LogUtils.getString(this.targets)
				+ ", Exclude dependencies: "
				+ LogUtils.getStringFromDependencies(this.excludeDependencies)
				+ ", Compile classpath elements: "
				+ LogUtils.getString(this.compileClasspathElements);
	}
