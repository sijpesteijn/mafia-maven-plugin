...
public class MavenUtils {
    ...
    public String[] getStringArrayFromConfiguration(final Xpp3Dom configuration, final String name) {
        if (configuration != null) {
            final Xpp3Dom child = configuration.getChild(name);
            if (child != null) {
    ...
    public Dependency[] getDependencyArrayFromConfiguration(final Xpp3Dom configuration, final String name) {
        if (configuration != null) {
            final Xpp3Dom child = configuration.getChild(name);
