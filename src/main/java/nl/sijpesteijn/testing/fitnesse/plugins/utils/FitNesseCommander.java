...
public class FitNesseCommander {
     ...
     * 
     * @param process {@link java.lang.Process}
     */
     ...
     * 
     * @param buffer {@link java.lang.StringBuilder}
    ...
    public void update() throws MojoExecutionException {
        ...
        try {
            final File controlFile =
                    new File(config.getWikiRoot() + "/FitNesseRoot/PageHeader/properties.xml");
    ...
    private FitNesseContext loadContext() throws MojoFailureException {
        ...
        try {
            // context.pageFactory = componentFactory.getHtmlPageFactory(new HtmlPageFactory());
            context.testResultsDirectoryName = config.getMafiaTestResultsDirectory();
            context.root =
                    wikiPageFactory.makeRootPage(context.rootPath, context.rootDirectoryName,
                        componentFactory);
        } catch (final Exception e) {
    ...
    public void clearTestResultsDirectory() throws MojoExecutionException {
        final String directoryName =
                config.getWikiRoot() + File.separatorChar + config.getNameRootPage() + File.separatorChar
                        + "files" + File.separatorChar + config.getMafiaTestResultsDirectory();
