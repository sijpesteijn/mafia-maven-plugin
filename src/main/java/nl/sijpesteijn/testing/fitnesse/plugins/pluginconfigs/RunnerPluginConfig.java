...
public class RunnerPluginConfig implements PluginConfig {
    ...
    public RunnerPluginConfig(final String wikiRoot, final String resultsListenerClass,
    ...
    public static class Builder implements PluginConfigBuilder {
        ...
        public RunnerPluginConfig build() {
            return new RunnerPluginConfig(wikiRoot, resultsListenerClass, fitnesseOutputDirectory, port,
    ...
    public String toString() {
        return "FitNesse Output Directory: " + this.fitnesseOutputDirectory + ", Port: " + this.port
                ...
                + ", Stop Tests On Exception: " + this.stopTestsOnException + ", Stop Tests On Failure: "
                + this.stopTestsOnFailure + ", Stop Tests On Ignore: " + this.stopTestsOnIgnore
                + ", Stop Tests On Wrong: " + this.stopTestsOnWrong + ", Tests: " + this.tests.toString()
                + ", Suites: " + this.suites.toString() + ", SuiteFilter: " + this.suiteFilter + ", Suite Pagename: "
                + this.suitePageName;
    }
}
